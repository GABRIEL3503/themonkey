...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function toggleStatus(button) {
    ...
    fetch(`https://buscoalquiler.com.ar/api/turnos/${turnoId}`, {
      method: 'PUT',
      headers: {
 ...
 fetch('https://buscoalquiler.com.ar/api/turnos')
      ...
      Object.keys(turnosPorDia).sort((a, b) => {
        ...
        turnosPorDia[dia].forEach(turno => {
          ...
          clientButton.addEventListener("click", function () {
            ...
            fetch(`https://buscoalquiler.com.ar/api/clientes/${turnoId}`)
              .then(response => {
                ...
                if (cliente && (cliente.nombre || cliente.telefono || cliente.email)) {
                  ...
                  Swal.fire({
                    ...
                    preConfirm: () => {
                      ...
                      fetch(`https://buscoalquiler.com.ar/api/clientes`, {
                        method: 'POST',
                        headers: {
                          'Content-Type': 'application/json',
                        },
          ...
          reserveButton.addEventListener("click", function () {
            ...
            Swal.fire({
              title: '👉Para reservar realizá una seña de $400 (Si no podes venier y avisas con tiempo seran reintegrados, o quedarán a favor en tu proxio corte 💈)  Gracias!',
